...
export const ContactCard = props => {
	...
	return (
		<li className="list-group-item border border-danger">
			<div className="row w-100">
				<div className="col-12 col-sm-6 col-md-3 px-0">
					<img src={"https://decine21.com/img/upload/perfiles/al-pacino-5393/al-pacino-2-889-c.jpg"} className="rounded-circle mx-auto d-block img-fluid" />
				</div>
